...
class EditHabit extends StatefulWidget {
  ...
  const EditHabit({Key key, this.habit}) : super(key: key);
  @override
...
class _EditHabitState extends State<EditHabit> {
  ...
  void initState() {
    ...
    _after.text = widget.habit.name;
    _will.text = widget.habit.will;
  }
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('Edit Habit', style: BigBoldHeading),
                      Container(),
                    ],
                  ),
                  SizedBox(
                      ...
                      : Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () async {
                              ...
                              Document<Habit> docRef = Document<Habit>(
                                  path: '/habits/${widget.habit.id}');
                              ...
                              var goal = Habit(
                                ...
                                will: _will.text,
                                owner: user.uid,
                                dateGoals: widget.habit.dateGoals,
                                color: _selectedColor.value,
                                startDate: widget.habit.startDate,
                              );

                              await docRef.upsert(goal.toMap());
