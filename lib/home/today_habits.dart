            ...
            FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (habits.length > 0) {
                    print(habits);
                    var startToday = DateTime(selectedDate.year,
                        selectedDate.month, selectedDate.day, 0, 0, 0, 0, 0);

                    var endToday = DateTime(selectedDate.year,
                        selectedDate.month, selectedDate.day, 23, 59, 59, 0, 0);
